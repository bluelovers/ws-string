...
var t = require("runes2"), r = require("es6-class-prototype");
...
class UString extends String {
  ...
  static toArray(r) {
    return r instanceof UString ? r.toArray() : t.runes(String(r));
  }
  toArray() {
    return this._arr || (this._arr = t.runes(String(this))), this._arr;
  }
  split(t, r) {
    let e, i = String(this);
